...
abline(v=coef.variation.2015-1)
abline(v=-coef.variation.2015+1)
```
...
plot(a, d, main = "Mass Shootings Total Victims Before 9/11/2001",xlab = "Year", ylab = "Total Victims")
plot(x, w, main = "Mass Shootings Total Victims  After 9/11/2001", xlab = "Year", ylab = "Total Victims", ylim = c(0, 60) )
```
...
plot(a, c, main = "Mass Shootings Before 9/11/2001",xlab = "Year", ylab = "Injured", ylim = c(0, 60))
plot(x, y, main = "Mass Shootings After 9/11/2001", xlab = "Year", ylab = "Injured",ylim = c(0, 60))
