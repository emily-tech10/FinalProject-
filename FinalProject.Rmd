...
make a function with how we calculated this p value 
```{r}
...
```{r}
(sum(right.tail | left.tail, na.rm=TRUE))/sum(!is.na(bootstrap.rep)) #p value 
```

If you were using a 5% significance level, you would fail to reject. .... 
